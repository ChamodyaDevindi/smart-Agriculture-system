  ...
  return (
    <ThemedView style={[styles.mainContainer, { backgroundColor: theme.background }]}>
      <ScrollView contentContainerStyle={[styles.container, { paddingTop: safeAreaInsets.top + Spacing.four }]}>
        <ThemedText type="subtitle" style={styles.title}>💬 Farmer Chat</ThemedText>
        
        <ThemedView type="backgroundElement" style={styles.card}>
          <ThemedText style={styles.emoji}>💬</ThemedText>
          <ThemedText type="subtitle" style={styles.cardTitle}>Chat Coming Soon</ThemedText>
          <ThemedText type="default" themeColor="textSecondary" style={styles.cardBody}>
            Direct farmer-buyer chat channels will be integrated in Phase 9 of our plan.
          </ThemedText>
        </ThemedView>
